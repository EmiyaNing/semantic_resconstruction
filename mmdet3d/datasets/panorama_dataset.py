...
class PanoramaDataset(Det3DDataset):
    ...
    def __init__(self,
                 ...
                 data_prefix: dict = dict(
                     ...
                     pts_instance_mask='instance_mask',
                     pts_semantic_mask='semantic_mask',
                     img='Stanford3dDataset_v1.2_Aligned_Version',
                     depth="Stanford3dDataset_v1.2_Aligned_Version"
                    ),
    ...
    def parse_data_info(self, info: dict) -> dict:
        ...
        if self.modality['use_camera']:
            info["img_path"]=osp.join(self.data_prefix.get('img', ''),info["images"]["img_path"])
            info["depth"]["depth_image_path"]=osp.join(self.data_prefix.get('depth', ''),info["depth"]["depth_image_path"])
    ...
    def parse_ann_info(self, info: dict) -> dict:
        ...
        depth_img=Image.open(osp.join(info["depth"]["depth_image_path"]))
        depth=np.array(depth_img)
        ann_info["depth"]=depth
