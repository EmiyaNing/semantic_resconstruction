...
if __name__ == '__main__':
    ...
    parser.add_argument('--img', default="assets/preprocessed/camera_1b329c346b4e4b62b07e2796bd506eee_office_30_frame_equirectangular_domain_rgb_aligned_rgb.png",
                        help='Image texture in equirectangular format')
    parser.add_argument('--layout',default="assets/inferenced/camera_1b329c346b4e4b62b07e2796bd506eee_office_30_frame_equirectangular_domain_rgb_aligned_rgb.json",
    ...
    parser.add_argument('--ignore_ceiling', default=True,
