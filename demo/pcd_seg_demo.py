...
def parse_args():
    ...
    parser.add_argument('--pcd',default="/autodl-fs/data/mmdetection3d/data/s3dis/points/Area_1_conferenceRoom_1.bin", help='Point cloud file')
    parser.add_argument('--model',default="/autodl-fs/data/mmdetection3d/configs/pointnet2/pointnet2_msg_2xb16-cosine-80e_s3dis-seg.py", help='Config file')
    parser.add_argument('--weights',default="/autodl-fs/data/mmdetection3d/tools/work_dirs/pointnet2_msg_2xb16-cosine-80e_s3dis-seg/epoch_50.pth", help='Checkpoint file')
    parser.add_argument(
