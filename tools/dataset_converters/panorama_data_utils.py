...
class PanoramaData(object):
    ...
    def __init__(self, root_path, split='Area_1',use_v1=False):
        ...
        self.image_dir = osp.join(self.split, 'image')
    ...
    def get_infos(self, num_workers=1, has_label=True, sample_id_list=None):
        ...
        def process_single_scene(sample_idx):
            ...
            #process single scene rgb-image and depth-image
            img_path = osp.join(self.split,sample_idx, f'{sample_idx}_rgb.png')#need
            image_info = {
            ...
            depth_path=osp.join(self.split,sample_idx,f"{sample_idx}_depth.png")
            depth_info={
    ...
    #     label_filename = osp.join(self.label_dir, f'{idx}.txt')
    #     lines = [line.rstrip() for line in open(label_filename)]
    #     # objects = [PanoramaInstance(line) for line in lines]
    #     return lines

class PanoramaSegData(object):
