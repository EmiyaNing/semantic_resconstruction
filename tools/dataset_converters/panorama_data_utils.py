...
class PanoramaData(object):
    ...
    def __init__(self, root_path, split='train', use_v1=False):
        ...
        self.split = split
        self.split_dir = osp.join(root_path,split)
        self.classes = [
        ...
        split_file = osp.join(root_path, split)
        ...
        self.image_dir = osp.join(self.split_dir, 'img')
        ...
        if use_v1:
            ...
            self.label_dir = osp.join(self.split_dir, 'label_cor')

    def __len__(self):
        return len(self.sample_id_list)

    def get_image(self, idx):
        img_filename = osp.join(self.image_dir, f'{idx:06d}.png')
    ...
    def get_infos(self, num_workers=1, has_label=True, sample_id_list=None):
        ...
        def process_single_scene(sample_idx):
            ...
            img_path = osp.join('image', f'{sample_idx:06d}.png')
            image_info = {
            ...
            if has_label:
                ...
                annotations['label_cor']=np.array([obj_list])
